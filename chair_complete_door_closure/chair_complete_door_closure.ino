...
void loop() {
  ...
  while (door_closure_flag == true) {
    ...
    if (val1 == LOW || val2 == LOW || val3 == HIGH && (oldSwitchState_pin1 != val1 && oldSwitchState_pin2 != val2 && oldSwitchState_pin3 !=  val3) && distance <= proximity_threshold && distance > 0) {
      ...
      // control if the monkey is still in the right position
      unsigned int distance = sonar.ping_cm(); // proximity sensor
